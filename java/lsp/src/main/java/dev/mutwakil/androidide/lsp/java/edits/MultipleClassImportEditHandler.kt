...
class MultipleClassImportEditHandler(
  ...
  override fun performEdits(
    ...
    editor: CodeEditor,
    completionItem: dev.mutwakil.androidide.lsp.models.CompletionItem
  ) {
    val edits = mutableListOf<dev.mutwakil.androidide.lsp.models.TextEdit>()
    ...
    dev.mutwakil.androidide.lsp.util.RewriteHelper.performEdits(edits, editor)
  }
}
