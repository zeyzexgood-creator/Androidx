...
import dev.mutwakil.androidide.lsp.java.models.DiagnosticCode.EMPTY_BLOCK
import dev.mutwakil.androidide.lsp.java.models.DiagnosticCode.UNUSED_THROWS
import dev.mutwakil.androidide.lsp.java.visitors.DiagnosticVisitor
...
import dev.mutwakil.androidide.utils.DocumentUtils.isSameFile
...
object DiagnosticsProvider {
  ...
  private fun getPosition(position: Long, lines: LineMap): dev.mutwakil.androidide.models.Position {
    abortIfCancelled()
    ...
    return dev.mutwakil.androidide.models.Position(line, column)
  }
