...
import dev.mutwakil.androidide.lsp.java.Rewrite.ImplementAbstractMethods
  ...
  override suspend fun execAction(data: ActionData): Any {
    val diagnostic =
      JavaDiagnosticUtils.asJCDiagnostic(
        data.get(
          dev.mutwakil.androidide.lsp.models.DiagnosticItem::class.java)!!.extra as Diagnostic<out JavaFileObject>
      )
