...
package dev.mutwakil.androidide.lsp.java.indexing

import androidx.test.ext.junit.runners.AndroidJUnit4
import com.google.common.truth.Truth.assertThat
import dev.mutwakil.androidide.indexing.core.platform.ApiInfo
import dev.mutwakil.androidide.lsp.java.indexing.classfile.ArrayAnnotationElementValue
import dev.mutwakil.androidide.lsp.java.indexing.classfile.ClassAnnotationElementValue
import dev.mutwakil.androidide.lsp.java.indexing.classfile.EnumAnnotationElementValue
import dev.mutwakil.androidide.lsp.java.indexing.classfile.IAnnotationElementValue
import dev.mutwakil.androidide.lsp.java.indexing.classfile.JavaConstant
import dev.mutwakil.androidide.lsp.java.utils.JavaType
import dev.mutwakil.androidide.lsp.java.indexing.classfile.PrimitiveAnnotationElementValue
import dev.mutwakil.androidide.testing.android.rules.RealmDBTestRule
...
class SharedModelCRUDTest {
  ...
  fun testApiInfoCreate() {
    dbTestRule.withDb("api-info") {
      val apiInfo = dev.mutwakil.androidide.indexing.core.platform.ApiInfo.newInstance(since = 1, deprecatedIn = 21, removedIn = 23)
