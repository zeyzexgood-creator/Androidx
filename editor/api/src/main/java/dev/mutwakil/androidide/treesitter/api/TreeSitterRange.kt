...
class TreeSitterRange @JvmOverloads internal constructor(
  ...
  companion object {
    ...
    fun obtain(startByte: Int, endByte: Int, startPoint: TSPoint?,
      ...
      return _root_ide_package_.dev.mutwakil.androidide.treesitter.api.obtainFromPool<TreeSitterRange>()
          .apply {
  ...
  override fun recycle() {
    (this.startPoint as? dev.mutwakil.androidide.treesitter.api.TreeSitterPoint?)?.recycle()
    (this.endPoint as? dev.mutwakil.androidide.treesitter.api.TreeSitterPoint?)?.recycle()
