...
package dev.mutwakil.androidide.lsp.internal.model
...
private constructor(
  ...
  val result: dev.mutwakil.androidide.lsp.models.CompletionResult
) {
  ...
  companion object {
    ...
    val EMPTY =
      cache(
        CompletionParams(
          dev.mutwakil.androidide.models.Position.NONE,
          Paths.get(""), ICancelChecker.CANCELLED
        ),
        dev.mutwakil.androidide.lsp.models.CompletionResult.EMPTY
      )
    ...
    fun cache(
      ...
      result: dev.mutwakil.androidide.lsp.models.CompletionResult
    ): CachedCompletion {
      val params =
