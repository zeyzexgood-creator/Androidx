...
/**
 * A Gradle project model which is identical to [IGradleProject][dev.mutwakil.androidide.tooling.api.IGradleProject]. This project module caches all the data
 * from an [IGradleProject][dev.mutwakil.androidide.tooling.api.IGradleProject] eliminating the use of [CompletableFuture] s.
 *
