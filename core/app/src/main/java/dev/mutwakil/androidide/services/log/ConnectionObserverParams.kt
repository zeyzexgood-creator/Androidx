...
data class ConnectionObserverParams(val clientId: String, val totalConnections: Int) {
  ...
  companion object {
    ...
    const val KEY_CLIENT_ID = "dev.mutwakil.androidide.logreceiver.connectedClientId"
    const val KEY_CONNECTION_COUNT = "dev.mutwakil.androidide.logreceiver.connectionCount"
