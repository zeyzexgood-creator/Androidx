 ...
 */
package dev.mutwakil.androidide.window
...
import dev.mutwakil.androidide.window.ActivityCompatHelperApi24.isInMultiWindowMode
import dev.mutwakil.androidide.window.ActivityCompatHelperApi30.currentWindowBounds
import dev.mutwakil.androidide.window.ActivityCompatHelperApi30.maximumWindowBounds
import dev.mutwakil.androidide.window.DisplayCompatHelperApi17.getRealSize
import dev.mutwakil.androidide.window.DisplayCompatHelperApi28.safeInsetBottom
import dev.mutwakil.androidide.window.DisplayCompatHelperApi28.safeInsetLeft
import dev.mutwakil.androidide.window.DisplayCompatHelperApi28.safeInsetRight
import dev.mutwakil.androidide.window.DisplayCompatHelperApi28.safeInsetTop
