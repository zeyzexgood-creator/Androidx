...
class WindowManager(
   ...
   * from the [dev.mutwakil.androidide.window.sidecar.SidecarInterface] or is passed directly to the
   * [dev.mutwakil.androidide.window.extensions.ExtensionInterface].
   */
