...
import static dev.mutwakil.androidide.fuzzysearch.FuzzySearch.partialRatio;
import static dev.mutwakil.androidide.fuzzysearch.FuzzySearch.ratio;
import static dev.mutwakil.androidide.fuzzysearch.FuzzySearch.tokenSetPartialRatio;
import static dev.mutwakil.androidide.fuzzysearch.FuzzySearch.tokenSetRatio;
import static dev.mutwakil.androidide.fuzzysearch.FuzzySearch.tokenSortPartialRatio;
import static dev.mutwakil.androidide.fuzzysearch.FuzzySearch.tokenSortRatio;
import static dev.mutwakil.androidide.fuzzysearch.algorithms.PrimitiveUtils.max;
import static java.lang.Math.round;

import dev.mutwakil.androidide.fuzzysearch.ToStringFunction;
