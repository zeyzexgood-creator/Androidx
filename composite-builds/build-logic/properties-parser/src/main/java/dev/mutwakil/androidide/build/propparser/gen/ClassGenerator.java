...
package dev.mutwakil.androidide.build.propparser.gen;

import static java.util.stream.Collectors.toList;

import dev.mutwakil.androidide.build.propparser.parser.Message;
import dev.mutwakil.androidide.build.propparser.parser.MessageFile;
import dev.mutwakil.androidide.build.propparser.parser.MessageInfo;
import dev.mutwakil.androidide.build.propparser.parser.MessageLine;
import dev.mutwakil.androidide.build.propparser.parser.MessageType;
import dev.mutwakil.androidide.build.propparser.parser.MessageType.CompoundType;
import dev.mutwakil.androidide.build.propparser.parser.MessageType.CustomType;
import dev.mutwakil.androidide.build.propparser.parser.MessageType.SimpleType;
import dev.mutwakil.androidide.build.propparser.parser.MessageType.UnionType;
import dev.mutwakil.androidide.build.propparser.parser.MessageType.Visitor;
