...
import dev.mutwakil.androidide.lsp.xml.providers.completion.common.CommonAttrCompletionProvider
import dev.mutwakil.androidide.lsp.xml.providers.completion.etc.InheritingAttrCompletionProvider
import dev.mutwakil.androidide.lsp.xml.providers.completion.layout.LayoutAttrCompletionProvider
import dev.mutwakil.androidide.lsp.xml.providers.completion.layout.LayoutTagCompletionProvider
import dev.mutwakil.androidide.lsp.xml.providers.completion.manifest.ManifestAttrCompletionProvider
import dev.mutwakil.androidide.lsp.xml.providers.completion.manifest.ManifestAttrValueCompletionProvider
import dev.mutwakil.androidide.lsp.xml.providers.completion.manifest.ManifestTagCompletionProvider
import dev.mutwakil.androidide.lsp.xml.utils.AnimTagTransformer
import dev.mutwakil.androidide.lsp.xml.utils.AnimatorTagTransformer
import dev.mutwakil.androidide.lsp.xml.utils.DrawableTagTransformer
import dev.mutwakil.androidide.lsp.xml.utils.ITagTransformer
import dev.mutwakil.androidide.lsp.xml.utils.MenuTagTransformer
import dev.mutwakil.androidide.lsp.xml.utils.NoOpTagTransformer
import dev.mutwakil.androidide.lsp.xml.utils.TransitionTagTransformer
import dev.mutwakil.androidide.lsp.xml.utils.XmlUtils
...
import dev.mutwakil.androidide.lsp.xml.utils.XmlUtils.NodeType.ATTRIBUTE_VALUE
import dev.mutwakil.androidide.lsp.xml.utils.XmlUtils.NodeType.TAG
import dev.mutwakil.androidide.lsp.xml.utils.XmlUtils.NodeType.UNKNOWN
import dev.mutwakil.androidide.lsp.xml.utils.forTransitionAttr
import dev.mutwakil.androidide.utils.CharSequenceReader
