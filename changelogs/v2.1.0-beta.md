...
- The installation process in this version vastly different from previous version. Please
  see [this](https://github.dev/mutwakil/androidide-build-tools#installing-in-androidide) for the new
...
- Use [ported version of NetBeans' `nb-javac`](https://github.dev/mutwakil/nb-javac-android) for Java
  language server.
