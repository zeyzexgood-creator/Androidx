...
package dev.mutwakil.androidide.tooling.api.models.result

/**
 * Result sent to the client when selecting a project in [IProjectQueries][dev.mutwakil.androidide.tooling.api.IProjectQueries].
 *
