...
package dev.mutwakil.androidide.inflater.vectormaster.models;
...
import dev.mutwakil.androidide.inflater.vectormaster.DefaultValues;
import dev.mutwakil.androidide.inflater.vectormaster.utilities.Utils;
import dev.mutwakil.androidide.inflater.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (useLegacyParser) {
      originalPath =
          dev.mutwakil.androidide.inflater.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(
              pathData);
    } else {
