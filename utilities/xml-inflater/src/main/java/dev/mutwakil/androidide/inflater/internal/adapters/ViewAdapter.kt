...
import dev.mutwakil.androidide.inflater.IViewAdapter
import dev.mutwakil.androidide.inflater.internal.IncludeView
import dev.mutwakil.androidide.inflater.models.UiWidget
import dev.mutwakil.androidide.inflater.utils.newAttribute
...
open class ViewAdapter<T : View> : IViewAdapter<T>() {
  ...
  protected open fun parseDrawingCacheQuality(value: String): Int {
    return dev.mutwakil.androidide.inflater.internal.utils.parseDrawingCacheQuality(value)
  }

  protected open fun parseVisibility(value: String): Int {
    return dev.mutwakil.androidide.inflater.internal.utils.parseVisibility(value)
  }

  protected open fun parseTextAlignment(value: String): Int {
    return dev.mutwakil.androidide.inflater.internal.utils.parseTextAlignment(value)
  }

  protected open fun parseTextDirection(value: String): Int {
    return dev.mutwakil.androidide.inflater.internal.utils.parseTextDirection(value)
  }

  protected open fun parsePorterDuffMode(mode: String): PorterDuff.Mode {
    return dev.mutwakil.androidide.inflater.internal.utils.parsePorterDuffMode(mode)
  }
