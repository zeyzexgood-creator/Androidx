 ...
 * - [ViewAdapter][dev.mutwakil.androidide.annotations.inflater.ViewAdapter] is used to specify the
 *   view whose attributes are handled by the view adapter implementation.
 * - [IncludeInDesigner][dev.mutwakil.androidide.annotations.uidesigner.IncludeInDesigner] is used to
...
abstract class IViewAdapter<T : View> : AbstractParser() {
   ...
   * [ViewAdapter][dev.mutwakil.androidide.annotations.inflater.ViewAdapter] annotation.
   *
