...
import dev.mutwakil.androidide.templates.SrcSet
import dev.mutwakil.androidide.templates.TemplateBuilder
import dev.mutwakil.androidide.templates.TemplateRecipeConfigurator
import dev.mutwakil.androidide.templates.TemplateRecipeFinalizer
import dev.mutwakil.androidide.templates.base.models.Dependency
import dev.mutwakil.androidide.templates.base.models.defaultDependency
import dev.mutwakil.androidide.templates.base.util.SourceWriter
import java.io.File
...
abstract class ModuleTemplateBuilder :
   ...
   * @see dev.mutwakil.androidide.templates.base.baseAsset
   */
  open fun baseAsset(path: String) =
    dev.mutwakil.androidide.templates.base.util.baseAsset("module", path)
   ...
   * [Implementation][dev.mutwakil.androidide.templates.base.models.DependencyConfiguration.Implementation]
   * configuration.
   *
