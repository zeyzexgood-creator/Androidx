...
internal class WorkspaceViewAttrHandler : dev.mutwakil.androidide.inflater.IView.AttributeChangeListener {
  ...
  override fun onAttributeAdded(view: dev.mutwakil.androidide.inflater.IView, attribute: dev.mutwakil.androidide.inflater.IAttribute) {
    val frag = this.fragment ?: return
    frag.undoManager.push(AttrAddedAction(view = view, attr = attribute as UiAttribute))
  }

  override fun onAttributeRemoved(view: dev.mutwakil.androidide.inflater.IView, attribute: dev.mutwakil.androidide.inflater.IAttribute) {
    val frag = this.fragment ?: return
