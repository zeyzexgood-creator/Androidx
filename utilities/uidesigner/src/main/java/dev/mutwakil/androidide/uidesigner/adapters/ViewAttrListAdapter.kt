...
package dev.mutwakil.androidide.uidesigner.adapters
...
import dev.mutwakil.androidide.inflater.IView.SingleAttributeChangeListener
import dev.mutwakil.androidide.uidesigner.R
import dev.mutwakil.androidide.uidesigner.adapters.ViewAttrListAdapter.VH
import dev.mutwakil.androidide.uidesigner.databinding.LayoutViewattrItemBinding
...
internal class ViewAttrListAdapter(
  attributes: List<dev.mutwakil.androidide.inflater.IAttribute>,
  private val viewModel: WorkspaceViewModel?,
  private val onDeleteAttr: (dev.mutwakil.androidide.inflater.IAttribute) -> Boolean,
  private val onClick: (dev.mutwakil.androidide.inflater.IAttribute) -> Unit
    ...
    binding.root.setOnClickListener {
      ...
      val attrUpdateListener =
        object : SingleAttributeChangeListener() {
          override fun onAttributeUpdated(view: dev.mutwakil.androidide.inflater.IView, attribute: dev.mutwakil.androidide.inflater.IAttribute, oldValue: String) {
