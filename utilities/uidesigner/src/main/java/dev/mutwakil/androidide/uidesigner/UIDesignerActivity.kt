...
package dev.mutwakil.androidide.uidesigner
...
import dev.mutwakil.androidide.actions.ActionItem.Location.UI_DESIGNER_TOOLBAR
...
import dev.mutwakil.androidide.uidesigner.actions.clearUiDesignerActions
import dev.mutwakil.androidide.uidesigner.actions.registerUiDesignerActions
import dev.mutwakil.androidide.uidesigner.databinding.ActivityUiDesignerBinding
import dev.mutwakil.androidide.uidesigner.R
import dev.mutwakil.androidide.uidesigner.fragments.DesignerWorkspaceFragment
import dev.mutwakil.androidide.uidesigner.utils.ViewToXml
...
class UIDesignerActivity : BaseIDEActivity() {
  ...
  fun setupHierarchy(view: dev.mutwakil.androidide.inflater.IView) {
