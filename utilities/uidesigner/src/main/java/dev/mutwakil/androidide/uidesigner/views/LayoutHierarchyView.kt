...
package dev.mutwakil.androidide.uidesigner.views
...
constructor(
  ...
  private fun addViews(view: IView, depth: Int) {
    ...
    if (view is dev.mutwakil.androidide.inflater.IViewGroup) {
  ...
  private fun computeChildCount(view: dev.mutwakil.androidide.inflater.IViewGroup): Int {
    var count = view.childCount
    view.forEachIndexed { index, child ->
      if (index != view.childCount - 1 && child is dev.mutwakil.androidide.inflater.IViewGroup) {
