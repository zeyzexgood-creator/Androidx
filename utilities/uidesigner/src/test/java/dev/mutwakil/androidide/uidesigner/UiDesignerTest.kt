...
import dev.mutwakil.androidide.inflater.internal.utils.ViewFactory
import dev.mutwakil.androidide.inflater.viewGroup
import dev.mutwakil.androidide.lookup.Lookup
import dev.mutwakil.androidide.uidesigner.utils.UiInflaterComponentFactory
...
fun Context.createLayout(parent: dev.mutwakil.androidide.inflater.IViewGroup? = null): ViewGroupImpl {
...
fun Context.createView(parent: dev.mutwakil.androidide.inflater.IViewGroup? = null): ViewImpl {
  return ViewImpl(LayoutFile(File(""), ""), View::class.qualifiedName!!, View(this)).apply {
    parent?.let { applyLayoutParams(it) }
  }
}

fun ViewImpl.applyLayoutParams(parent: dev.mutwakil.androidide.inflater.IViewGroup) {
